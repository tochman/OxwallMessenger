...
define('OW_URL_HOME', 'http://www.yourdomain.com');
define('OW_URL_IMAGE', 'http://www.yourdomain.com');
...
define('DB_USER', 'xxxx');    // MySQL account username
define('DB_PASS', 'xxxx');    // MySQL account password
define('DB_NAME', 'xxxx');     // Name of database
define('OW_PASSWORD_SALT', 'xxxx'); //Password encryption
