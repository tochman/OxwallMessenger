...
- (void)showIntroWithCrossDissolve {
    ...
    page1.title = @"BETA 0.5";
    page1.desc = @"Select access to pre-approved Oxwall sites (powered wit our API). TimeStamp issue in MessageVie is resolved. Notification badge should be tested in real enviroment ";
